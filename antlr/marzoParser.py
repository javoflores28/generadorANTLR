...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("A\4\2\t\2\4\3\t\3\4\4\t\4\3\2\6\2\n\n\2\r\2\16\2\13\3")
        ...
        buf.write("\2\3\4\5\2\4\6\2\2\2J\2\t\3\2\2\2\4\20\3\2\2\2\6>\3\2")
        buf.write("\2\2\b\n\5\4\3\2\t\b\3\2\2\2\n\13\3\2\2\2\13\t\3\2\2\2")
        buf.write("\13\f\3\2\2\2\f\3\3\2\2\2\r\16\b\3\1\2\16\21\7\20\2\2")
        buf.write("\17\21\7\21\2\2\20\r\3\2\2\2\20\17\3\2\2\2\21)\3\2\2\2")
        buf.write("\22\23\f\13\2\2\23\24\7\3\2\2\24(\5\4\3\f\25\26\f\b\2")
        buf.write("\2\26\27\7\4\2\2\27(\5\4\3\t\30\31\f\7\2\2\31\32\7\5\2")
        buf.write("\2\32(\5\4\3\b\33\34\f\6\2\2\34\35\7\6\2\2\35(\5\4\3\7")
        buf.write("\36\37\f\5\2\2\37 \7\7\2\2 (\5\4\3\6!\"\f\4\2\2\"#\7\b")
        buf.write("\2\2#(\5\4\3\5$%\f\3\2\2%&\7\t\2\2&(\5\4\3\4\'\22\3\2")
        buf.write("\2\2\'\25\3\2\2\2\'\30\3\2\2\2\'\33\3\2\2\2\'\36\3\2\2")
        buf.write("\2\'!\3\2\2\2\'$\3\2\2\2(+\3\2\2\2)\'\3\2\2\2)*\3\2\2")
        buf.write("\2*\5\3\2\2\2+)\3\2\2\2,-\7\n\2\2-.\5\4\3\2./\7\13\2\2")
        buf.write("/\60\5\6\4\2\60?\3\2\2\2\61\62\7\n\2\2\62\63\5\4\3\2\63")
        buf.write("\64\7\13\2\2\64\65\5\6\4\2\65\66\7\f\2\2\66\67\5\6\4\2")
        buf.write("\67?\3\2\2\289\7\r\2\29?\7\21\2\2:;\7\16\2\2;?\7\20\2")
        buf.write("\2<=\7\17\2\2=?\5\4\3\2>,\3\2\2\2>\61\3\2\2\2>8\3\2\2")
        buf.write("\2>:\3\2\2\2><\3\2\2\2?\7\3\2\2\2\7\13\20\')>")
        return buf.getvalue()
...
class marzoParser ( Parser ):
    ...
    class SiSinoContext(StatementContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterSiSino" ):
                listener.enterSiSino(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitSiSino" ):
                listener.exitSiSino(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitSiSino" ):
                return visitor.visitSiSino(self)
            else:
                return visitor.visitChildren(self)


    class SiContext(StatementContext):
    ...
    class DeclaroNumeroContext(StatementContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterDeclaroNumero" ):
                listener.enterDeclaroNumero(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitDeclaroNumero" ):
                listener.exitDeclaroNumero(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitDeclaroNumero" ):
                return visitor.visitDeclaroNumero(self)
            else:
                return visitor.visitChildren(self)


    class ImprimoContext(StatementContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterImprimo" ):
                listener.enterImprimo(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitImprimo" ):
                listener.exitImprimo(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitImprimo" ):
                return visitor.visitImprimo(self)
            else:
                return visitor.visitChildren(self)


    class DeclaroPalabraContext(StatementContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterDeclaroPalabra" ):
                listener.enterDeclaroPalabra(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitDeclaroPalabra" ):
                listener.exitDeclaroPalabra(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitDeclaroPalabra" ):
                return visitor.visitDeclaroPalabra(self)
            else:
                return visitor.visitChildren(self)
    ...
    def statement(self):
        ...
        try:
            ...
            if la_ == 1:
                localctx = marzoParser.SiContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 42
                ...
                localctx = marzoParser.SiSinoContext(self, localctx)
                ...
                localctx = marzoParser.DeclaroPalabraContext(self, localctx)
                ...
                localctx = marzoParser.DeclaroNumeroContext(self, localctx)
                ...
                localctx = marzoParser.ImprimoContext(self, localctx)
